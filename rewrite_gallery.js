...
import { ArrowLeft, ChevronLeft, ChevronRight, ImageIcon, X, Image as ImageIcon2 } from 'lucide-react';
              ...
              {(() => {
                 ...
                 return (
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-4">
                       {subPhotos.map(photo => (
                          <div key={photo.id} className="aspect-[4/5] bg-[#070f23] rounded-xl overflow-hidden border border-slate-800 relative group">
                             ...
                             <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/80 to-transparent p-3 text-center">
                                <span className="text-[11px] font-mono font-bold text-white tracking-widest">{photo.photoCode}</span>
                             </div>
